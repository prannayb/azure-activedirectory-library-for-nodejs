...
/**
 * Obtains an access token using the authorizationCode and the app's client certificate.  The certificate is used to generate a self signed
 * JWT token that is passed as a client_assertion.
 * @param  {string}                 authorizationCode   Auth code returned by adal for this user's grant
 * @param  {string}                 certificate         A PEM encoded certificate private key.
 * @param  {string}                 thumbprint          A hex encoded thumbprint of the certificate.
 * @param  {AcquireTokenCallback}   callback
 */
TokenRequest.prototype.getTokenWithAuthCodeAndClientCertificate = function(authorizationCode, certificate, thumbprint, callback) {
  this._log.info('Getting a token via certificate.');
...
/**
 * Obtains an access token using the refresh token and the app's client certificate.  The certificate is used to generate a self signed
 * JWT token that is passed as a client_assertion.
 * @param  {string}                 refreshToken        The refresh token returned with the original acess token
 * @param  {string}                 certificate         A PEM encoded certificate private key.
 * @param  {string}                 thumbprint          A hex encoded thumbprint of the certificate.
 * @param  {AcquireTokenCallback}   callback
 */
TokenRequest.prototype.getTokenWithRefreshTokenAndClientCertificate = function(refreshToken, certificate, thumbprint, callback) {
  this._log.info('Getting a token via certificate.');
